...
export default class LeaderboardController implements Controller {
    ...
    private getLeaderboard = async (req: RavenRequest, res: Response, next: NextFunction) => {
        leaderboardGet(req, res, next).catch(e => next(e));
    }

    private getLeaderboardGuilds = async (req: RavenRequest, res: Response, next: NextFunction) => {
